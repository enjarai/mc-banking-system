...
execute as @e[tag=bank] at @s as @e[scores={sneak=1..,money=1..},distance=..3,nbt=!{Inventory:[{Slot:-106b,id:minecraft:gold_nugget}]}] run give @s gold_nugget 1
execute as @e[tag=bank] at @s as @e[scores={sneak=1..,money=1..},distance=..3,nbt=!{Inventory:[{Slot:-106b,id:minecraft:gold_nugget}]}] run scoreboard players remove @s money 1
